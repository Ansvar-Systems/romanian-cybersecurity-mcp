 ...
 *
 * Schema:
 *   - guidance    — DNSC guidelines, technical standards, and recommendations
 *   - advisories  — DNSC security advisories and alerts
 *   - frameworks  — DNSC framework series (National Cybersecurity Strategy, NIS2 implementation)
 *
