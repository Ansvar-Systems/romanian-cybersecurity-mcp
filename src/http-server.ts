      ...
      switch (name) {
        ...
        case "ro_cyber_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "BSI (DNSC (Directoratul Național de Securitate Cibernetică)) MCP server. Provides access to BSI technical guidelines, IT-Grundschutz building blocks, BSI Standards, and security advisories.",
